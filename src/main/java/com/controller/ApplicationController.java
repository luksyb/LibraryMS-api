...
public class ApplicationController {
    ...
    public List<Book> getBooks(@RequestParam String name, @RequestParam String author, @RequestParam String thumbnailImage) {
        return userImpl.getAll(name, author, thumbnailImage);
    }
